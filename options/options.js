...
function SetEvents() {
    ...
    document.getElementById("folder_icon_open").onmouseenter = function(event) {
            AddRedStylePreview("f_folder1_folder_expand", "backgroundColor", "red", true);
        }
        // folder icon closed
    document.getElementById("folder_icon_closed").onmouseenter = function(event) {
            AddRedStylePreview("f_folder2_folder_expand", "backgroundColor", "red", true);
        }
        // folder icon hover
    document.getElementById("folder_icon_hover").onmouseenter = function(event) {
        AddBlueBackgroundPreview("f_folder3_folder_expand", true);
    }
    ...
    document.getElementById("drag_indicator").onmouseenter = function(event) {
        AddRedStylePreview("_drag_indicator19", "borderBottom", "1px solid red", true);
    }
